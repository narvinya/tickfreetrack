...
import PozadieBiele from "@/components/PozadieBiele.vue";
...
export default {
  components: {
    ...
    PozadieBiele: PozadieBiele
  },
  computed: {
    patogeny() {
      return this.data.patogeny;
    }
  },
  data: function() {
    return {
  ...
  methods: {
    vyberPatogen: function(patogen) {
      this.vybranyPatogen = patogen;
    }
  }
};
</script>
